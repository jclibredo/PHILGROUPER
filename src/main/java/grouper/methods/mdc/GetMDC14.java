...
//                DRGWSResult ORProcedureResult = new ORProcedure().ORProcedure(datasource, procData.trim());
//                if (ORProcedureResult.isSuccess()) {
//                    ORProcedureCounter++;
//                    ORProcedureCounterList.add(Integer.valueOf(ORProcedureResult.getResult()));
//                    DRGWSResult ResultUnralated = new UnralatedANDORProc().UnralatedANDORProc(datasource,
...
//                    }
//                }
//                DRGWSResult Result14PFX = axResult.AX(datasource, "14PFX", procData.trim());
//                if (Result14PFX.isSuccess()) {
//                    Counter14PFX++;
//                }
//                DRGWSResult Result14PGX = axResult.AX(datasource, "14PGX", procData.trim());
//                if (Result14PGX.isSuccess()) {
//                    Counter14PGX++;
//                }
//                DRGWSResult Result14PJX = axResult.AX(datasource, "14PJX", procData.trim());
//                if (Result14PJX.isSuccess()) {
//                    Counter14PJX++;
//                }
//                DRGWSResult Result14PEX = axResult.AX(datasource, PEX14, procData.trim());
//                if (Result14PEX.isSuccess()) {
//                    Counter14PEX++;
//                }
//                DRGWSResult Result14PBX = axResult.AX(datasource, PBX14, procData.trim());
//                if (Result14PBX.isSuccess()) {
//                    Counter14PBX++;
//                }
//                DRGWSResult Result14PCX = axResult.AX(datasource, "14PCX", procData.trim());
//                if (Result14PCX.isSuccess()) {
//                    Counter14PCX++;
//                }
//                DRGWSResult Result14PHX = axResult.AX(datasource, PHX14, procData.trim());
...
//                    //}
//                }
//                DRGWSResult Result14PDX = axResult.AX(datasource, PDX14, procData.trim());
//                if (Result14PDX.isSuccess()) {
//                    Counter14PDX++;
//                }
//
...
//            int Counter14JX = 0;
//            int ICD10mdcCounter = 0;
//            DRGWSResult Result14KX = axResult.AX(datasource, KX14, grouperparameter.getPdx().trim());
...
//
//                DRGWSResult Result14EX = axResult.AX(datasource, EX14, SDxAxData.trim());
//                if (Result14EX.isSuccess()) {
//                    Counter14EX++;
//                }
//                DRGWSResult Result14DX = axResult.AX(datasource, DX14, SDxAxData.trim());
//                if (Result14DX.isSuccess()) {
//                    Counter14DX++;
//                }
//                DRGWSResult Result14CX = axResult.AX(datasource, CX14, SDxAxData.trim());
//                if (Result14CX.isSuccess()) {
//                    Counter14CX++;
//                }
//                DRGWSResult Result14BX = axResult.AX(datasource, BX14, SDxAxData.trim());
//                if (Result14BX.isSuccess()) {
//                    Counter14BX++;
//                }
//                DRGWSResult Result14HX = axResult.AX(datasource, HX14, SDxAxData.trim());
//                if (Result14HX.isSuccess()) {
//                    Counter14HX++;
//                }
//                DRGWSResult Result14FX = axResult.AX(datasource, FX14, SDxAxData.trim());
//                if (Result14FX.isSuccess()) {
//                    Counter14FX++;
//                }
//                DRGWSResult pdxResult = new PDXandMDC().PDXandMDC(datasource, SDxAxData.trim(), drgResult.getMDC());
//                if (pdxResult.isSuccess()) {
//                    ICD10mdcCounter++;
//                }
//
//                DRGWSResult SDX14gxresult = axResult.AX(datasource, GX14, SDxAxData.trim());
//                if (SDX14gxresult.isSuccess()) {
//                    Counter14GX++;
//                }
//
//                DRGWSResult SDX14jxresult = axResult.AX(datasource, JX14, SDxAxData.trim());
...
//            int dxas14Fx = 0;
//
//            DRGWSResult pdxax14cxresult = axResult.AX(datasource, CX14, grouperparameter.getPdx());
//            if (pdxax14cxresult.isSuccess()) {
//                pdxax14cx++;
//            }
//            DRGWSResult pdxax14dxresult = axResult.AX(datasource, DX14, grouperparameter.getPdx());
//            if (pdxax14dxresult.isSuccess()) {
//                pdxax14dx++;
//            }
//
//            DRGWSResult pdxax14fxresult = axResult.AX(datasource, FX14, grouperparameter.getPdx().trim());
//            if (pdxax14fxresult.isSuccess()) {
//                dxas14Fx++;
//            }
//            DRGWSResult pdxax14bxresult = axResult.AX(datasource, BX14, grouperparameter.getPdx());
//            if (pdxax14bxresult.isSuccess()) {
//                pdxax14bx++;
//            }
//            DRGWSResult dxasax14hxresult = axResult.AX(datasource, HX14, grouperparameter.getPdx());
//            if (dxasax14hxresult.isSuccess()) {
//                dxax14Hx++;
//            }
//            DRGWSResult dxasax14gxresult = axResult.AX(datasource, GX14, grouperparameter.getPdx());
//            if (dxasax14gxresult.isSuccess()) {
//                dxax14Gx++;
//            }
//            DRGWSResult dxasax14jxresult = axResult.AX(datasource, JX14, grouperparameter.getPdx());
...
//            int J14Counter = 0;
//
//            PDxMalignancy getMalignant = new PDxMalignancy();
//            DRGWSResult D14Result =getMalignant.PDxMalignancy(datasource, grouperparameter.getPdx(), D14);
//            if (D14Result.isSuccess()) {
//                D14Counter++;
//            }
//            DRGWSResult E14Result = getMalignant.PDxMalignancy(datasource, grouperparameter.getPdx(), E14);
//            if (E14Result.isSuccess()) {
//                E14Counter++;
//            }
//            DRGWSResult G14Result = getMalignant.PDxMalignancy(datasource, grouperparameter.getPdx(), G14);
//            if (G14Result.isSuccess()) {
//                G14Counter++;
//            }
//            DRGWSResult H14Result = getMalignant.PDxMalignancy(datasource, grouperparameter.getPdx(), H14);
//            if (H14Result.isSuccess()) {
//                H14Counter++;
//            }
//            DRGWSResult K14Result = getMalignant.PDxMalignancy(datasource, grouperparameter.getPdx(), K14);
//            if (K14Result.isSuccess()) {
//                K14Counter++;
//            }
//            DRGWSResult L14Result = getMalignant.PDxMalignancy(datasource, grouperparameter.getPdx(), L14);
//            if (L14Result.isSuccess()) {
//                L14Counter++;
//            }
//            DRGWSResult J14Result = getMalignant.PDxMalignancy(datasource, grouperparameter.getPdx(), J14);
...
//                            }
//                            for (int x = 0; x < SecondaryList.size(); x++) {
//                                DRGWSResult sdxfinderResult = axResult.AX(datasource, BX14, SecondaryList.get(x));
//                                if (sdxfinderResult.isSuccess()) {
//                                    sdxfinder.add(SecondaryList.get(x));
//                                }
//                            }
...
//                            }
//                            for (int x = 0; x < SecondaryList.size(); x++) {
//                                DRGWSResult sdxfinderResult = axResult.AX(datasource, EX14, SecondaryList.get(x));
//                                if (sdxfinderResult.isSuccess()) {
//                                    sdxfinder.add(SecondaryList.get(x));
//                                }
//                            }
...
//                        drgResult.setDRG("26040");
//                        drgResult.setDC("2604");
//                        DRGWSResult drgname = new DRG().DRG(datasource, drgResult.getDC(), drgResult.getDRG());
//                        if (drgname.isSuccess()) {
//                            drgResult.setDRGName(drgname.getMessage());
//                        }
//                    } else {
