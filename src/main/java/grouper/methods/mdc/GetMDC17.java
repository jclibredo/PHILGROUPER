...
//            String PA17 = "17PA";
            ...
            for (int x = 0; x < ProcedureList.size(); x++) {
                if (new Endovasc().Endovasc(datasource, ProcedureList.get(x).trim(), "17PA", drgResult.getMDC()).isSuccess()) {
                    Counter17PA++;
                }
                ...
                if (new AX().AX(datasource, "17PBX", ProcedureList.get(x).trim()).isSuccess()) {
                    Counter17PBX++;
                }
                //AX 99PDX Checking
